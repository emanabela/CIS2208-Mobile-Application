...
public class Frag2MainCourse extends Fragment implements MenuAdapter.onItemListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_main_course_layout, container, false);

        //declaring myDb
        myDb = new DatabaseHelper(view.getContext());

        //getting the recyclerView
        RecyclerView recyclerView = view.findViewById(R.id.list_of_main_course);
